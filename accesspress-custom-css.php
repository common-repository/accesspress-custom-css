...
if( !class_exists( 'APC_Css_free' ) ) {
    class APC_Css_free
    {
        ...
        function __construct() {
            ...
            add_filter( 'plugin_action_links_' . plugin_basename(__FILE__), array($this, 'apccss_action_links') );
        ...
        function apccss_action_links( $actions ) {
           $actions[] = '<a href="'. esc_url( get_admin_url(null, 'admin.php?page=accesspress-custom-css') ) .'">'.__( 'Settings', APCCSS_TEXT_DOMAIN ).'</a>';;
           return $actions;
        }
    }
