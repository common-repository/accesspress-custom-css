        ...
        <div class="apccss-form-wraper">
            <div class="apccss-head">
                <div class="apccss-setting-header clearfix">
                    <h3><?php _e( 'AccessPress Custom CSS', 'accesspress-custom-css' ); ?></h3>
...
?>
            ...
            <form action="<?php echo admin_url() . 'admin-post.php' ?>" method='post'>
                <h2 class="nav-tab-wrapper wp-clearfix">
        			<a href="javascript:void(0);" class="nav-tab nav-tab-active apccss-tabs-trigger" id="apccss-custom-css-settings"><?php _e( 'Custom CSS settings', 'accesspress-custom-css' ); ?></a>
        			<a href="javascript:void(0);" class="nav-tab apccss-tabs-trigger" id="apccss-about"><?php _e( 'More WordPress Stuff', 'accesspress-custom-css' ); ?></a>
                ...
                <div class='apccss-tab-contents apccss-active-tab' id='tab-apccss-custom-css-settings'>
                        ...
                        <p><input type="submit" class="apccss-submit-css button-primary" name='apccss_save_settings' value="<?php _e( 'Save', 'accesspress-custom-css' ); ?>"/> </p>
    ...
    echo $options['css'];
                        ...
                        <a class="apccss-top-button" href="javascript:void(0);">^</a>

                        <div class="apccss-actions">
                            <input type="submit" class="apccss-bottom-submit button-primary" name='apccss_save_settings' value="<?php _e( 'Save', 'accesspress-custom-css' ); ?>" />
                            ...
                            <a class="apccss-btn-wrap" href="<?php echo admin_url() . 'admin-post.php?action=apccss_restore_default_settings&_wpnonce=' . $nonce; ?>" onclick="return confirm('<?php _e( 'Are you sure you want to clear the editor?', 'accesspress-custom-css' ); ?>')"><input type="button" value="<?php _e( 'Clear Editor', 'accesspress-custom-css' ); ?>" class="apccss-reset-button button-primary"/></a>
                        </div>
                </div>
